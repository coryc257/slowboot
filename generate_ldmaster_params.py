...
if __name__ == '__main__':
	...
	os.system("find /lib64/ -type f -name \"*.so.*\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' >> "+pwd+"/ldm.param.temp")
	os.system("find /usr/lib/ -type f -name \"*.so\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' > "+pwd+"/ldm.param.temp")
	os.system("find /usr/lib/ -type f -name \"*.so.*\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' >> "+pwd+"/ldm.param.temp")
	os.system("find /usr/lib64/ -type f -name \"*.so\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' > "+pwd+"/ldm.param.temp")
	os.system("find /usr/lib64/ -type f -name \"*.so.*\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' >> "+pwd+"/ldm.param.temp")
	...
	os.system("find /lib64/ -type l -name \"*.so.*\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' >> "+pwd+"/ldm.param.temp")
	os.system("find /usr/lib/ -type l -name \"*.so\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' >> "+pwd+"/ldm.param.temp")
	os.system("find /usr/lib/ -type l -name \"*.so.*\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' >> "+pwd+"/ldm.param.temp")
	os.system("find /usr/lib64/ -type l -name \"*.so\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' >> "+pwd+"/ldm.param.temp")
	os.system("find /usr/lib64/ -type l -name \"*.so.*\" -executable 2>/dev/null -exec sha512sum {} \; | awk '{print $1,$2;}' >> "+pwd+"/ldm.param.temp")
